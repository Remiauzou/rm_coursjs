 ...
 * @version 5.0 - MODE BRUTE FORCE - Variation Julien
 *
 */
...
function verifieMotDePasse(evenement) {
     ...
     *
     */
    input_mdp.value.split('').forEach( function(lettre) {
        /**
...
function estMinuscule(lettre) {
    const alphas = 'abcdefghijklmopqrstuvwxyzàáâãäåèéêëçìíîïðòóôõöùúûüýÿ';
    return alphas.includes(lettre) ? true : false;
}

function estNombre(lettre) {
    const chiffres = '0123456789';
    return chiffres.includes(lettre) ? true : false;
}
